...
import com.soy6115.databinding.ActivityOtrosDatosBinding
import com.soy6115.utilidad.Constantes

class AOtrosDatos : AppCompatActivity() {

    private lateinit var binding: ActivityOtrosDatosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOtrosDatosBinding.inflate(layoutInflater)
    ...
    private fun activarBotones() {
        ...
        val liFormacion = binding.tvBTNFormacion
        liFormacion.setOnClickListener {
